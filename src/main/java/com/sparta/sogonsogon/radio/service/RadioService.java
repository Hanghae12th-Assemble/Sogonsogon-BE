...
public class RadioService {
    ...
    // 라디오생성
    @Transactional
    public StatusResponseDto<RadioResponseDto> createRadio(RadioRequestDto requestDto, Member user) throws IOException {


            //유저인지 확인
            Member member = memberRepository.findByMembername(user.getMembername()).orElseThrow(
